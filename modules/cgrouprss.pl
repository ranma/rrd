#!/usr/bin/perl
# $Id: cgrouprss.pl,v 1.17 2007/04/04 22:02:20 mitch Exp $
#
...
# set variables
my $datafile = "$conf{DBPATH}/cgrouprss.rrd";
my $picbase  = "$conf{OUTPATH}/cgrouprss-";
...
foreach ( [3600, "hour"], [86400, "day"], [604800, "week"], [31536000, "year"] ) {
    ...
    RRDs::graph($picbase . $scale . ".png",
		...
		'--lazy',
		'--imgformat=PNG',
		"--title=${hostname} cgroup rss usage (last $scale)",
		'--upper-limit=100',
